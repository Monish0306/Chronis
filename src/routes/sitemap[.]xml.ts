    ...
    handlers: {
      GET: async () => {
        const entries: SitemapEntry[] = [
          ...
          { path: "/pairing", changefreq: "monthly", priority: "0.6" },
          { path: "/vault", changefreq: "monthly", priority: "0.6" },
          { path: "/mode", changefreq: "monthly", priority: "0.6" },
          { path: "/ready", changefreq: "monthly", priority: "0.4" },
